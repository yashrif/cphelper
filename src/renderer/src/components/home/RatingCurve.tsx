...
import { LineChart, Line, Legend, Tooltip, ResponsiveContainer } from "recharts";
...
export const RatingCurve = () => {
  ...
  const isUserRatingHistory = useAppSelector((state) => state.cf.loading.userRatingHistory);
